...
{
    public class MaleAuthorFactory : AuthorFactory
    {
        public override Author GetAuthor(int authorId, string authorName, string address, string history, string phoneNumber)
        {
            MaleAuthor postAuthor = new MaleAuthor(authorId, authorName, address, history, phoneNumber);
        ...
        {
            MaleAuthor postAuthor = new MaleAuthor(authorName, address, history, phoneNumber);
            Author author = new Author()
            {
                AuthorName = postAuthor.AuthorName,
                Address = postAuthor.Address,
